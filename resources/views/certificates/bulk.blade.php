...
<form method="POST" action="{{ route('certificates.bulk.store') }}" id="bulkForm" class="lg:col-span-2">
@csrf
    <div class="space-y-5">
        {{-- Event & Template --}}
        <div class="card p-6">
                    ...
                    <tbody id="studentsBody">
                        ...
                        <tr class="border-t border-gray-100">
                            ...
                            <td class="px-2 py-1.5">
                                <select name="students[{{ $i }}][achievement]" class="border border-gray-200 rounded px-2 py-1 text-xs focus:outline-none">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('certificates.index') }}" class="px-6 py-3 border border-gray-200 rounded-xl text-sm text-gray-600 hover:bg-gray-50">Cancel</a>
        </div>
    </div>
</form>
